...
const militaryData = JSON.parse(
  fs.readFileSync(require.resolve("../json/tech/military.json"))
);
const infrastructureData = JSON.parse(
  fs.readFileSync(require.resolve("../json/tech/infrastructure.json"))
);
const medicalData = JSON.parse(
  fs.readFileSync(require.resolve("../json/tech/medical.json"))
);
const agricultureData = JSON.parse(
  fs.readFileSync(require.resolve("../json/tech/agriculture.json"))
);
const analysisData = JSON.parse(
  fs.readFileSync(require.resolve("../json/tech/analysis.json"))
);
const techData = [
  ...militaryData,
  ...infrastructureData,
...
const { Research, KnowledgeResearch } = require("../../models/research");
...
async function techSeed() {
  for await (let research of await Research.find({
