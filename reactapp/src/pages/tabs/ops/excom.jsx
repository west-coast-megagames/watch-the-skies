...
import InfoAircraft from '../../../components/infoAircaft'
    ...
    render() { 
        return (
            <React.Fragment>
                ...
                <Interceptors 
                    aircrafts={ this.props.aircrafts.filter(el => el.team._id === this.props.team._id) }
                ...
                { this.state.showInfo ? <InfoAircraft
