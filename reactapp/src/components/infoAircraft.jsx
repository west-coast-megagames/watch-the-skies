  ...
  render() {
    return (
      ...
      >
        ...
        <Drawer.Footer>
          <Button
            onClick={() => this.props.hideAircraft()}
            appearance="primary"
          >
            Confirm
          </Button>
          <Button onClick={() => this.props.hideAircraft()} appearance="subtle">
            Cancel
          </Button>
        </Drawer.Footer>
        <SelectPicker />
        ...
        <FlexboxGrid>
          ...
          <FlexboxGrid.Item colspan={12}>
            ...
            <div>
              <Whisper
                placement="top"
                speaker={penetrationSpeaker}
                trigger="click"
              >
                <IconButton size="xs" icon={<Icon icon="info-circle" />} />
              </Whisper>
              <b> Weapon Pentration:</b> {stats.penetration}
            </div>
            <div>
...
const hullSpeaker = (
  <Popover title="Hull Information">
    <p>
      Hull is the strangth of your aircrafts chassis, if it goes to 0 your
      aircraft will crash!
    </p>
  </Popover>
);
...
const armorSpeaker = (
  <Popover title="Armor Information">
    <p>
      Armor protects your crafts systems from damage or destruction. If a system
      looses its cockpit or engines it can crash.
    </p>
  </Popover>
);
...
const penetrationSpeaker = (
  <Popover title="Penetration Information">
    <p>
      Penetration is your Weapons systems ability to do internal damage to an
      opponent. Destroying opponent systems can cause them to crash.
    </p>
  </Popover>
);
...
const rangeSpeaker = (
  <Popover title="Range Information">
    <p>
      Range is the distance your aircraft can travel for a mission in km. The
      distance is calculated from your base.
    </p>
  </Popover>
);
...
const weaponSpeaker = (
  <Popover title="Penetration Information">
    <p>
      Weapon rating is how much hull damage your weapons can do on a succesful
      hit.
    </p>
  </Popover>
);
...
const evadeSpeaker = (
  <Popover title="Penetration Information">
    <p>
      Evade is your crafts ability to avoid damage even when succefully hit, it
      also effects ability to disengage.
    </p>
  </Popover>
);
