...
const facilityData = JSON.parse(
  fs.readFileSync(require.resolve("../json/facilities/facilities.json"))
);
const aircraftData = JSON.parse(
  fs.readFileSync(require.resolve("../json/aircraft_bp.json"))
);
//const squadData = JSON.parse(); //js dislikes empty parse functions
const facilityUpgrade = JSON.parse(
  fs.readFileSync(require.resolve("../json/upgrades/facilityUpgrades"))
);
const militaryUpgrade = JSON.parse(
  fs.readFileSync(require.resolve("../json/upgrades/militaryUpgrades"))
);
const aircraftUpgrade = JSON.parse(
  fs.readFileSync(require.resolve("../json/upgrades/aircraftUpgrades"))
);
