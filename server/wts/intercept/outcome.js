...
function outcome (unit, roll, stance) {
	const aggresiveArray = unit.stats.activeRolls; // Results table from the aircraft
	const passiveArray = unit.stats.passiveRolls; // Results table from the aircraft
	const { name } = unit; // Destructure of unit to allow the easy use of name
	const result = {
